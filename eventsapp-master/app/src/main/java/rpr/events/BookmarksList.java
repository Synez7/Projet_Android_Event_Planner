...
public class BookmarksList extends Fragment {
    ...
    // Manipulation des événements favoris via une DB SQLite
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // Récupérations des infos de connexion d'un utilisateur
        context = getActivity();
        queue = Volley.newRequestQueue(context);
        session = new UserSessionManager(getContext());
        HashMap<String, String> user = session.getUserDetails();
        user_id = user.get(UserSessionManager.KEY_USER_ID);
        usertype = user.get(UserSessionManager.KEY_USERTYPES);
    ...
    private void load_data_from_server(final int id) {
        ...
        // Requête POST envoyée au serveur pour demander l'affichage de la liste des événements favoris
        StringRequest eventRequest= new StringRequest(Request.Method.POST,"https://eventplannerapp.000webhostapp.com/listBookmark.php",
                new Response.Listener<String>()
                {
                    ...
                    {
                        try{
                            System.out.println("MES BOOKMARKS : " + response);
